...
class VF_IC:
    def uOfXT(self, x, t):
        if ct.wave: return smoothedHeaviside(ct.epsFact_consrv_heaviside*ct.opts.he,x[1]-(ct.waterLevel+ct.wave.eta(x,t)))
        else:
            return smoothedHeaviside(ct.epsFact_consrv_heaviside*ct.opts.he,x[1]-ct.waterLevel)
